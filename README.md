...
Application desktop développée en JavaFX et MySQL dans le cadre d’un stage académique de 2 mois en 2024.
...
![Planning Mensuel](screenshots/planning-mensuel.png)
...
1. Ouvrir phpMyAdmin
2. Créer la base `securestaff_desktop`
